...
export function AdvancedScrollIndicator({ className, sections = [], showLabels = true }: AdvancedScrollIndicatorProps) {
  ...
  return (
    <>
      {/* Desktop Navigation */}
      <div className={cn("hidden lg:flex fixed right-8 top-1/2 -translate-y-1/2 z-50 flex-col gap-2", className)}>
        ...
        {/* Section indicators */}
        {sections.length > 0 && (
          <div className="flex flex-col gap-3 items-start h-64 justify-start ml-6 space-y-2">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50">
        <div
          className="h-1 bg-gradient-to-r from-blue-500 to-purple-600 transition-all duration-150 ease-out"
